 ...
 function enterKeyPressed(event) {
  ...
  function student_options(){
    $('.btn_enroll').on('click',function(){
      ...
      window.location.href ="../admin/enrollment_new.php?data_id="+en_id;
    });

    $('.btn_grades').on('click',function(){
      var gd_id = $(this).attr('id');
      window.location.href ="../admin/enrollment_grades.php?data_id="+gd_id;
    });

    $('.btn_view').on('click',function(){
      var vw_id = $(this).attr('id');
      window.location.href ="../admin/enrollment_view.php?data_id="+vw_id;
    });
