        ...
        while($row = $result->fetch_assoc()) {
           ...
           <div class="col-sm-3">
            ...
            <p class="text-danger">Delete</p>
                ...
                <button type="button" class="btn btn-tool btn-xl btn-update" data-toggle="modal"  id="'.$row['id'].'">
                ...
                <p class="text-success">Update</p>
                    ...
                    <div class="card-body cscroll">
                        ...
                        <h2 class="card-title">Tittle:'.$row['tittle'].'</h2><br>
                        <p> Activity type : '.$row['type'].'</p>
